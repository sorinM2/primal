...
namespace primal::graphics::d3d12
{
	...
	public:
		...
		constexpr d3d12_texture(d3d12_texture&& o) : _resource{ std::move(o._resource) }, _srv{ std::move(o._srv) }
		{
			o.reset();
		}
	...
	public:
		...
		constexpr ID3D12Resource* const resource() { return _texture.resource(); }
	private:
	...
	public:
		...
		constexpr descriptor_handle srv() const { return _texture.srv(); }
		constexpr ID3D12Resource* resource() const { return _texture.resource(); }
	private:
		d3d12_texture _texture{};
