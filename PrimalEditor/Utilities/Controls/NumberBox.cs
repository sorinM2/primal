...
namespace PrimalEditor.Utilities.Controls
{
    ...
    class NumberBox : Control
    {
        ...
        public static readonly RoutedEvent ValueChangedEvent = EventManager.RegisterRoutedEvent(nameof(ValueChangedEvent), RoutingStrategy.Bubble, typeof(RoutedEventHandler), 
            typeof(NumberBox));
